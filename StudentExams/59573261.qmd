...
This is the final exam for student number: **59573261**.  Confirm your student number is correct before proceeding.  **Do not complete someone else's exam.** 
...
* For these questions, download the answer sheet for your exam, which can be found [here](https://raw.githubusercontent.com/GEOS270/FinalExam/main/sheets/59573261.zip).  
...
**2**	
Ptolemy's Geographia is the first known example of a(n) [  <sub>2.0</sub>  ]. It consisted of eight volumes and a [  <sub>2.1</sub>  ] world map.

**3**	
The [  <sub>3.0</sub>  ] arises when we aggregate individual data values into larger [  <sub>3.1</sub>  ] with arbitrary boundaries.

**4**	
Random sampling is a/an [  <sub>4.0</sub>  ] method for collecting spatial information.  Stratified random sampling and cluster sampling are [  <sub>4.1</sub>  ] methods for collecting spatial information that are designed to help address some of the downsides of random sampling.

**5**	
Metadata is [  <sub>5.0</sub>  ] about [  <sub>5.1</sub>  ].
