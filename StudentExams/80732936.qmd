...
For these questions, download the answer sheet for your exam, which can be found [here](https://github.com/GEOS270/FinalExam/raw/main/sheets/80732936_AnswerSheet.zip).  
...
**5**	
Resolution is a property of your [  <sub>5.0</sub>  ], scale is a property of your [  <sub>5.1</sub>  ].
