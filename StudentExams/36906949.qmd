...
This is the final exam for student number: **36906949**.  Confirm your student number is correct before proceeding.  **Do not complete someone else's exam.** 
...
* For these questions, download the answer sheet for your exam, which can be found [here](https://raw.githubusercontent.com/GEOS270/FinalExam/main/sheets/36906949.zip).  
...
**6**	
[  <sub>6.0</sub>  ] is the process of assigning spatial [  <sub>6.1</sub>  ] to images like scanned historical maps.
