...
This is the final exam for student number: **99781544**.  Confirm your student number is correct before proceeding.  **Do not complete someone else's exam.** 
...
* For these questions, download the answer sheet for your exam, which can be found [here](https://raw.githubusercontent.com/GEOS270/FinalExam/main/sheets/99781544.zip).  
...
**2**	
An attribute [  <sub>2.0</sub>  ] contains non-spatial data, that is linked to spatial data using an [  <sub>2.1</sub>  ].
