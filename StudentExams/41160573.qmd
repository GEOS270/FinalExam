...
This is the final exam for student number: **41160573**.  Confirm your student number is correct before proceeding.  **Do not complete someone else's exam.** 
...
* For these questions, download the answer sheet for your exam, which can be found [here](https://raw.githubusercontent.com/GEOS270/FinalExam/main/sheets/41160573.zip).  
...
**8**	
[  <sub>8.0</sub>  ] is the process of assigning spatial [  <sub>8.1</sub>  ] to images like scanned historical maps.
