...
This is the final exam for student number: **25015579**.  Confirm your student number is correct before proceeding.  **Do not complete someone else's exam.** 
...
* For these questions, download the answer sheet for your exam, which can be found [here](https://raw.githubusercontent.com/GEOS270/FinalExam/main/sheets/25015579.zip).  
...
**6**	
[  <sub>6.0</sub>  ] is a branch of [  <sub>6.1</sub>  ] that deals with the nature of right and wrong.
