...
For these questions, download the answer sheet for your exam, which can be found [here](https://github.com/GEOS270/FinalExam/raw/main/sheets/63027346_AnswerSheet.zip).  
...
**8**	
Resolution is a property of your [  <sub>8.0</sub>  ], scale is a property of your [  <sub>8.1</sub>  ].
