...
This is the final exam for student number: **87585584**.  Confirm your student number is correct before proceeding.  **Do not complete someone else's exam.** 
...
* For these questions, download the answer sheet for your exam, which can be found [here](https://raw.githubusercontent.com/GEOS270/FinalExam/main/sheets/87585584.zip).  
...
**2**	
[  <sub>2.0</sub>  ] is the process of assigning spatial [  <sub>2.1</sub>  ] to images like scanned historical maps.
...
**8**	
Spatial [  <sub>8.0</sub>  ] is the process of estimating the values between point observations to create a continuous surface. A common method known as [  <sub>8.1</sub>  ] uses a function to estimate cell values based on their proximity to a set of known point observations.
