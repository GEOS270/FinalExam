...
For these questions, download the answer sheet for your exam, which can be found [here](https://github.com/GEOS270/FinalExam/raw/main/sheets/87585584_AnswerSheet.zip).  
...
**3**	
Resolution is a property of your [  <sub>3.0</sub>  ], scale is a property of your [  <sub>3.1</sub>  ].
