...
For these questions, download the answer sheet for your exam, which can be found [here](https://github.com/GEOS270/FinalExam/raw/main/sheets/85334150_AnswerSheet.zip).  
...
**4**	
Resolution is a property of your [  <sub>4.0</sub>  ], scale is a property of your [  <sub>4.1</sub>  ].
