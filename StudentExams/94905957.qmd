...
This is the final exam for student number: **94905957**.  Confirm your student number is correct before proceeding.  **Do not complete someone else's exam.** 
...
* For these questions, download the answer sheet for your exam, which can be found [here](https://raw.githubusercontent.com/GEOS270/FinalExam/main/sheets/94905957.zip).  
...
**6**	
Resolution is a branch of your [  <sub>6.0</sub>  ], scale is a property of your [  <sub>6.1</sub>  ].
