...
For these questions, download the answer sheet for your exam, which can be found [here](https://github.com/GEOS270/FinalExam/raw/main/sheets/94905957_AnswerSheet.zip).  
...
**6**	
Resolution is a property of your [  <sub>6.0</sub>  ], scale is a property of your [  <sub>6.1</sub>  ].
