...
This is the final exam for student number: **30288310**.  Confirm your student number is correct before proceeding.  **Do not complete someone else's exam.** 
...
* For these questions, download the answer sheet for your exam, which can be found [here](https://raw.githubusercontent.com/GEOS270/FinalExam/main/sheets/30288310.zip).  
...
**5**	
[  <sub>5.0</sub>  ] is the process of assigning spatial [  <sub>5.1</sub>  ] to images like scanned historical maps.
...
**7**	
[  <sub>7.0</sub>  ] is a technique that assigns spatial [  <sub>7.1</sub>  ] to text-based descriptions of locations (eg. street addresses).
